...
import com.ethlo.geodata.importer.AlternateNamesFileReader;
import com.ethlo.geodata.importer.BaseFileImporter;
import com.ethlo.geodata.importer.CountryParser;
...
@Component
public class FileGeonamesImporter extends BaseFileImporter<RawLocation>
{
    ...
    {
        super(basePath, GeonamesSource.LOCATION, geoNamesAllCountriesUrl, HEADERS, true, 0);
    ...
    protected void processing()
    {
        ...
        try (final CloseableIterator<Map<String, String>> iterator = rawIterator(getSourcePath(), HEADERS))
        {
            ...
            final Map<Integer, Integer> childToParent = HierachyBuilder.build(filtered, adminLevels, countries, null);
