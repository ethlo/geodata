...
import com.ethlo.geodata.importer.jdbc.DataImporter;
...
public abstract class BaseFileImporter<T extends CompactSerializable> implements DataImporter
{
    private final Path basePath;
    private final String url;
    private final GeonamesSource type;
    private final List<String> header;
    private final boolean isTsv;
    private final int skipLines;
    private Path sourcePath;

    public BaseFileImporter(final Path basePath, GeonamesSource type, String url, List<String> header, final boolean isTsv, int skipLines)
    {
        this.type = type;
    ...
    {
        return basePath.resolve(type.name().toLowerCase() + ".data");
    }
    ...
    protected String findMapValue(Map<String, String> map, String... needles)
    {
